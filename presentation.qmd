...
## Opening mini-activity

Pair up and exchange an experience you've had with managing your research files. Think about the master thesis or any other research project you've been a part of.

1. Pair up in teams of two.

2. Take a few minutes to exchange an experience.

3. One of you reports back to the group.

## Why should YOU care about a reproducible research pipeline?
...
- Code no longer works because the files it calls have moved.
- The number of observations in a regression does not make sense due to a bad initial merge of the data. When correcting the mistake, the results change dramatically.
- Someone suggests changing the sample definition. Updating it requires updating dozens of files because the code has been copied and pasted throughout the working directory.
- We want to collaborate with another researcher, but opening their directory reveals hundreds of code and files. Just figuring out which coding files to run in which order takes weeks. In the end, we give up and do everything from scratch.
- Working together in a directory on a cloud service causes everyone to be interrupted because changes one of us makes causes the other's code to break and produces conflicted copies.
...
## Reproducible research starts with you
...
\begin{center}
\includegraphics[width =0.15\textwidth]{"images/you.png"} \\
\end{center}
...
-   Please interrupt, ask questions, and share your experience.
...
3.  Integrating multiple engines: Example using Quarto
...
## What are key principles of a reproducible research pipeline?

**Universal principles:**

-   Anyone can run the code anywhere and anytime, regardless of location.
-   Anyone can understand the code and data without too much effort.
-   Anyone can change one number or one step and reproduce everything.
...
a.  Less than one hour (easy!)

b.  Between one hour and a day (It's possible but painful)

c.  More than one day (I'd be stuck)
