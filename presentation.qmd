...
Let's say you wrote your a research paper and your laptop died. 
How long would it take you to reproduce your analyses with a new laptop?
...
-   But let's make this interactive: Interupt, ask questions, + tell me about your experience.
...
-   LLMs are exciting, but to make them useful, you need to set realistic expectations:
    ...
    -   LLMs will not replace the need for you to code properly and organize your data. <!-- -   LLMs will not replace most human jobs (yet this won't prevent managers from thinking they can and replace people anyway) -->
